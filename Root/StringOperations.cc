...
bool StringOperations::starts_with(const string &main_string, const string &prefix)    {
...
bool StringOperations::ends_with(const string &main_string, const string &suffix)    {
...
std::vector<std::string> StringOperations::split_by_whitespaces(std::string line)   {
...
void StringOperations::strip_string(string *input_string, const string &chars_to_remove)    {
...
void StringOperations::to_upper(std::string *input_string) {
    std::transform(input_string->begin(), input_string->end(),input_string->begin(), ::toupper);
};

std::string  StringOperations::to_upper_copy(const std::string &input_string)  {
    string result = input_string;
    StringOperations::to_upper(&result);
    return result;
};

bool StringOperations::compare_case_insensitive(const std::string &x, const std::string &y)    {
    const string x_upper = StringOperations::to_upper_copy(x);
    const string y_upper = StringOperations::to_upper_copy(y);
